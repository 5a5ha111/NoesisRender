    ...
    SubShader 
    {
        ...
        HLSLINCLUDE
            ...
            float4 DeferredFragment(Varyings input) : SV_TARGET
            {
                ...
                float metallic = packedGB0.a;

                float smoothness = packedGB1.r;
                float2 normalXY = packedGB1.gb;
                float occlusion = packedGB2.a;

                //float2 positionView = packedGB2.xy;
                //float fresnelStrenght = packedGB2.b;
                float fresnelStrenght = 0.25f;
                ...
                float3 normal = NormalReconstructZ(normalXY);
                normal = packedGB1.gba;
                ...
                //float4 res = float4(metallic, 0, 0, 1);
                return res;
