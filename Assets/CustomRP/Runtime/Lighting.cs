...
public class Lighting
{
    ...
    void SetupDirectionalLight(int index, int visibleIndex, ref VisibleLight visibleLight)
    {
        ...
        dirLightDirections[index] = -visibleLight.localToWorldMatrix.GetColumn(2); // rotation
    ...
    void SetupSpotLight(int index, int visibleIndex, ref VisibleLight visibleLight)
    {
        ...
        position.w = 1f / Mathf.Max(visibleLight.range * visibleLight.range, 0.00001f); // store the (1 / r^2) of the light in w
        otherLightPositions[index] = position;
        otherLightDirections[index] = -visibleLight.localToWorldMatrix.GetColumn(2); // negate rotation
