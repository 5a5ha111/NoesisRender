...
namespace NoesisRender
{
    ...
    public class CustomRenderPipelineSettings
    {
        ...
        public class XeGTAOSettings
        {
            ...
            [Tooltip("Better leave on when use half res.")] public bool BicubicRescale = true;
            [Tooltip("If disabled, use different noise index each frame, better use with TAA.")] public bool TemporalStable = true;
